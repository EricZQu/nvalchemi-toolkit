...
class DistillationStrategy(TrainingStrategy):
    ...
    ValueError
        ...
        node-embedding shape, the student, projector, and teacher widths do
        not compose, or the projector declares ``frozen_student=True`` over a
        fully trainable student; with a Hessian objective, if the student computes no
